      ...
      {sqliteStatus.migrationStatus?.hasUnappliedMigrations && (
        ...
        >
          ...
          {sqliteStatus.migrationStatus.failedMigration ? (
            <div>
              <div
                style={{ fontSize: '11px', color: '#78350f', marginBottom: 4 }}
              >
                Migration {sqliteStatus.migrationStatus.failedMigration.version}{' '}
                failed. Extension may not work properly.
              </div>
            ...
            <div style={{ fontSize: '11px', color: '#78350f' }}>
              Some database migrations are pending. Please restart the
              extension.
            </div>
          )}
        </div>
